...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_split_bs_split_sp_small_rsft(
        ...
        KC_CAPS, KC_LGUI, KC_LALT,          KC_SPC,       MO(1),       KC_SPC,                MO(1),    KC_RGUI,  KC_APP,     KC_RCTL
    ),
    [1] = LAYOUT_60_split_bs_split_sp_small_rsft(
